...
### Monosaccharides
#### Definition
- **General Formula**: C<sub>n</sub>(H$_{2}0$)<sub>n</sub>; n = 3-7 carbon atoms (see[[#Classification (No. of Carbon atoms)]])
...
graph LR
    ...
    B --> E[Stereoisomers<br/>Minor atomic rearrangement]
    C --> E
    D --> F[Structural Isomer<br/>Different bonding pattern]
```
