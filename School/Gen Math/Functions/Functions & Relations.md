...
> [!information] 
> A function can be:
> 1. **Increasing:** graph is going up (slope is positive)
> 2. **Decreasing:** graph is going down (slope is negative)
> 3. **Constant:** graph is a straight horizontal line (y is constant)
