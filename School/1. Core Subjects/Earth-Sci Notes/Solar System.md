**The solar system** is located in the Milky Way Galaxy — which is located in the Virgo supercluster of galaxies — rotates around it every 240 million years. Assuming the solar system is the **remnants of the materials which they are formed**, radioactive dating of meteorites suggest that the solar system and earth are about **4.6 billion years old**.  
...
> [!info] 
> This is the **most widely accepted model** for explaining the origin of the Solar System. 

## Encounter Hypothesis
This theory states that the planets of the solar system were formed when a rogue star passed close to the sun, which **stripped material from the Sun and the rogue star**. This material fragmented into **smaller lumps which formed the planets.** 
> [!example] Proponents
> - Georges-Louis Leclerc

The **two biggest problems** with this theory are:
1. Hot gas **expands**; "lumps" of hot gas would not form planets 
2. Encounter of stars are **extremely rare**