...
While both have cell membranes and cell wall, there are still differences. All **prokaryotes** have cell wall (made of **peptidoglycan**), but no all eukaryotes do. Plants cell wall are made of **cellulose**, while fungi **chitin**. 

As for their cell membranes, prokaryotes have sterol-like lipid called **hopanoid**. Eukaryotes have sterols like **cholesterol** (animals), **phytosterol** (plants), and **ergosterol** (fungi). 
### Ribosomes 
Ribosomes are in both and have the same function, but they differ in location and structure. Ribosomes in prokaryotic cells are all found in the cytoplasm and are 70S. 

In eukaryotic cells, they can be found in the cytoplasm, outer nuclear membrane, rough ER, mitochondrion, and chloroplast, and are 80S. 

> [!important] 
> **Svedberg units (S)** is the sedimentation coefficient of ribosomes.  
...
## Reproduction
Prokaryotes can reproduce via [[Cell Reproduction#Binary Fission]] and [[Cell Reproduction#Spores]]. Eukaryotic cells can reproduce via [[Cell Reproduction#Mitosis]] and[[Cell Reproduction#Meiosis]].  
